    ...
    <div className="app">
      ...
      <aside className="sidebar">
        <div className="sidebar-top">
          ...
          <h1 className="title">
            <span className="title-line">TO</span>
            <span className="title-line">DO</span>
            <span className="title-line accent">LIST.</span>
          </h1>
        </div>
        <div className="counter-block">
          <span className="counter"><strong>{done}</strong> done</span>
          <span className="counter"><strong>{todos.length - done}</strong> left</span>
        </div>
      ...
      <main className="main">
        ...
        <div className="input-area">
          <div className="input-area-label">New Task</div>
